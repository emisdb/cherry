...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('guide_shorttext_En')); ?>:</b>
	<?php echo CHtml::encode($data->guide_shorttext_En); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('guide_maintext_En')); ?>:</b>
	<?php echo CHtml::encode($data->guide_maintext_En); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('lnk_to_license')); ?>:</b>
	<?php echo CHtml::encode($data->lnk_to_license); ?>
	<br />

...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_now')); ?>:</b>
	<?php echo CHtml::encode($data->date_now); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('GN_string')); ?>:</b>
	<?php echo CHtml::encode($data->GN_string); ?>
	<br />

        ...
        <!-- sidebar: style can be found in sidebar.less -->
         <section class="sidebar" style="height:auto;">
          ...
          <ul class="sidebar-menu">
             ...
             <li <?php echo (Yii::app()->controller->action->id=='spontour') ? "class=\"active\"" : "" ; ?>>
				<?php echo CHtml::link("<i class='fa fa-table'></i><span>Spontane Tourabrechnung</span>", array('guide/spontour','date'=>date('d.m.Y'))); ?>
            </li>

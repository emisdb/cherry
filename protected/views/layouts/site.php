        ...
        <div class="row">
            <div class="span12">
                <div style="padding-top:20px;">
                    <center><img src ="<?php echo Yii::app()->request->baseUrl; ?>/img/logo.png" /></center>
                </div>
            </div>
        </div>
...
<div class="carousel-inner"  role="listbox">
    ...
    <div class="item"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/munich.jpg" alt="Munich" />
        <div class="carousel-caption">
            ...
            <div class="t-carousel">Lean what makes this city special with our Special Tour</div>
        </div>
    </div>
    <div class="item"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/dresden.jpg" alt="Dresden" />
        <div class="carousel-caption">
            <div class="t-carousel-big">Dresden</div>
            <div class="t-carousel">Get deep into the city's history with our Historicel Tour</div>
        </div>
    </div>
    ...
    <div class="item"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/koln.jpg" alt="Koln" />
        <div class="carousel-caption">
            <div class="t-carousel-big">Koln</div>
            <div class="t-carousel">Lean what makes this city special with our Special Tour</div>
        </div>    
    </div>
</div>

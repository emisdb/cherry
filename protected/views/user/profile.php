...
<div class="create"><a href="<?php echo Yii::app()->createUrl('/user/update',array('id'=>$model->id)); ?>">Update profile information</a></div>
PROFILE INFORMATION
<hr />
...
<hr />
<div class="create"><a href="<?php echo Yii::app()->createUrl('/segContacts/update',array('id'=>$model->id,'id_user'=>$model->id)); ?>">Update profile contact</a></div>
CONTACTS
<hr />

   ...
   public $additional_address;
	...
	public function rules()
	{
		return array(
			...
			array('tour, language, firstname, lastname, city, country, phone, email, cat_hidden, tickets, tickets1, tickets2 , tickets3, street, house, additional_address, postalcode, info', 'safe'),
		);
	}

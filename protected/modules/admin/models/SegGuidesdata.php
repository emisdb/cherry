...
//			array('guides_cashbox_account_DTV, BIC, IBAN', 'required'),
			...
			array('BIC,IBAN,image,doc,lnk_to_picture, lnk_to_license, cancel_number, cancel_hours', 'safe'),
			array('BIC, IBAN', 'length', 'max'=>200),
//			array('image', 'file', 'maxSize'=>10*1024*1024),
//			array('doc', 'file', 'maxSize'=>10*1024*1024),
//                         array('guides_cashbox_account_DTV', 'default', 'value'=>'0'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'cancel_number' => 'Guest number for cancellation',
			'cancel_hours' => 'Hours number for cancellation',

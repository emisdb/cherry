<?php
class SegCitiesController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SegCities');
	 ...
	 * @return SegCities the loaded model
	 ...
	 * @param SegCities $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='seg-cities-form')
		{

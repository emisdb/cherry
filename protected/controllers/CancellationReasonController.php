...
class CancellationReasonController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CancellationReason');
	 ...
	 * @param CancellationReason $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cancellation-reason-form')
		{

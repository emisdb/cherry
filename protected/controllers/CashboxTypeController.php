...
class CashboxTypeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CashboxType');
	 ...
	 * @return CashboxType the loaded model
	 ...
	 * @param CashboxType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cashbox-type-form')
		{

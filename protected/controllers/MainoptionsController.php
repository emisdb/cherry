...
class MainoptionsController extends Controller
{
	 ...
	 * @return Mainoptions the loaded model
	 ...
	 * @param Mainoptions $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mainoptions-form')
		{

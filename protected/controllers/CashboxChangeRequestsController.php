...
class CashboxChangeRequestsController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CashboxChangeRequests']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idcashbox_change_requests));
		}
	 ...
	 * @return CashboxChangeRequests the loaded model
	 ...
	 * @param CashboxChangeRequests $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cashbox-change-requests-form')
		{
